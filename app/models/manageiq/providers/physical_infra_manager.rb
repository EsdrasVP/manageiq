module ManageIQ::Providers
  class PhysicalInfraManager < BaseManager
    ...
    has_many :switches, :foreign_key => "ems_id", :dependent => :destroy, :inverse_of => :ext_management_system, :class_name => "PhysicalSwitch"
    ...
    virtual_total :total_physical_switches, :switches
